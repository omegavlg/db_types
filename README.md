...
Масштабируемость: База данных должна легко увеличиваться, чтобы использовать все 1000 машин.
Производительность: База данных должна быстро обрабатывать запросы и выполнять вычисления.
Распределённое хранение: Данные должны храниться и обрабатываться на нескольких машинах одновременно.
Устойчивость к отказам: База данных должна продолжать работать, даже если какие-то машины выйдут из строя.
Поддержка сложных вычислений: База данных должна поддерживать сложные вычислительные задачи.
